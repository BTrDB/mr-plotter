...
function buildCSVMenu(self) {
    ...
    var widthdesc = [
      "8333333 ns (half a 60Hz cycle)",
      "10000000 ns (half a 50hz cycle)",
      "16666666 ns (one 60Hz cycle)", //full 60hz
      "20000000 ns (one 50Hz cycle)", //full 50hz
      "1000000000 ns (one second)", //second
      "60000000000 ns (one minute)", //minute
      "300000000000 ns (5 minutes)",
      "1800000000000 ns (30 minutes)",
      "3600000000000 ns (one hour)", //hour
      "86400000000000 ns (one day)" //day
    ];
